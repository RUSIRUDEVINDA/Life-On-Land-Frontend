            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <label className="inline-flex items-center gap-2 font-medium">
                    ...
                    <select
                        ...
                        className="rounded-2xl border border-border-light bg-white px-3 py-2 text-[13px] font-semibold text-primary-dark outline-none transition focus:border-primary-medium"
                    >
                        {[10, 20, 30].map((n) => (
